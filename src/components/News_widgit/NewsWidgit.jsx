...
const NewsWidgit = ({id,boxes,setBoxes}) => {
    ...
    useEffect(()=>{
        const setNews=async()=>{
            const response= await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/googlenewssearch',{
...
>>>>>>> Stashed changes
    ...
    return (
        <div className='w-[100%] h-[100%] flex flex-col font-sans'>
            ...
            <div className='w-[100%] h-[40px] relative bg-[#cc0000] flex items-center justify-between px-4'>
