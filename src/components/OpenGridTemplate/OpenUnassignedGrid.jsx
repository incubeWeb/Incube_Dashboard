    ...
    useEffect(() => {
        const settingRoles = async () => {
            ...
            await Promise.all(selectedUsers.map(async (user) => {
                await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/updateuser', {
                    email: user.email,
                    ...
                    const response = await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/addTeam', {
                    ...
                    await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/updateCompanystatus', {
                        company: companyName,
                        status: 'In Progress',
                        organization:localStorage.getItem('organization')
                    });
                    ...
                    {
                        await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/updateCompanyTeamLeadstatus', {
                            company: companyName,
