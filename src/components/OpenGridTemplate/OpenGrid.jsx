...
function OpenGrid({hidenavbar,setActiveField,companyName,description,handleOpenGrid}) {
  ...
  return (
    <div className={` ${hidenavbar?'ml-[2%] w-[100%]':'ml-[20%] w-[80%]'} min-h-[200px] z-50 space-y-7 bg-white absolute top-0 right-0 pt-[45px] overflow-hidden p-[23px] md:flex md:flex-col cursor-default`} onClick={handleBubbling}>
