...
const ChatWidgit = ({id,Useremail,handleSeeUsers,setclickeduseremail,realtimeChat,setBoxes,boxes}) => {
  ...
  useEffect(()=>{
    const fetchall=async()=>{
      ...
      setUsers(users)
      const UserChatpositionRes=await axios.post('http://ec2-13-233-247-65.ap-south-1.compute.amazonaws.com:8999/chatwidgituserpositionvalues',{
  ...
  useEffect(()=>{
    ...
    const setChats=async()=>{
        ...
        let response1=await axios.post('http://ec2-13-233-247-65.ap-south-1.compute.amazonaws.com:8999/readChat',{
          sender:localStorage.getItem('email'),
          receiver:openuser,
          organization:localStorage.getItem('organization')
        })
        let response2=await axios.post('http://ec2-13-233-247-65.ap-south-1.compute.amazonaws.com:8999/readChat',{
