...
const DashBoardSingleUserChat = ({receiver,clickUserField,openChatbar}) => {
  ...
  useEffect(()=>{
    const ReadMsg=async()=>
      {
        const response1=await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/readChat',{
          sender:localStorage.getItem('email'),
          receiver:receiver,
          organization:localStorage.getItem('organization')
        })
        const response2=await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/readChat',{
          sender:receiver,
