...
const PortfolioTopGraph = ({hidenavbar,sheetedited}) => {
    ...
    useEffect(()=>
    {
        const updateRealtimevalue=async()=>{
            ...
            const response1=await axios.post('http://ec2-13-233-247-65.ap-south-1.compute.amazonaws.com:8999/sheetfromdb',{id:sheetid,organization:localStorage.getItem('organization')})
