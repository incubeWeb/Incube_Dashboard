...
function EditCard({handleClose,id}) {
  ...
  useEffect(()=>{
    const FillField=async()=>{
      let organization=localStorage.getItem('organization')
        const RawData=await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/getSingleDetail',{id:id,organization:organization})
  ...
  const handleUpdate=async()=>{
    ...
    let organization=localStorage.getItem('organization')
    const res=await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/UpdateSingleDetail',{id:id,title:title,description:des,organization:organization})
