...
const ChartPopup = ({
  ...
  const handleUpload = async (e,chart) => {
    ...
    if (SelectedFile) {
        ...
        try {
            const response=await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/uploadsheetFile', formData);
...
>>>>>>> Stashed changes
  ...
  const selectedSheetFromDatabase=async(e)=>{
    ...
    const response=await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/sheetfromdb',{id:selectedsheetfromdbname,organization:localStorage.getItem('organization')});
    const data=JSON.parse(response.data.data)
