...
const handleKeyDown = (event) => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      // Check if the click is outside both the chat box and the toggle button
      if (
...
<div className="relative w-16 h-16 rounded-full cursor-pointer bg-gradient-to-br  from-blue-200 to-blue-300 opacity-50 shadow-lg flex items-center justify-center">
...
<div
  ...
  {showChat && (
  <div ref={chatRef} className="fixed w-[60%] h-[60%] bg-white border border-gray-300 rounded-lg p-4 right-10 bottom-36">
    
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto mb-2 scrollbar-hide" ref={chatRef}>
        ...
        {loading && !messages.some(msg => msg.sender === 'Bot' && msg.text.includes('Thinking')) && (
          <div className="text-start text-gray-600 mb-1">
      ...
      <div className="flex mt-auto">
        <input
          type="text"
          className="flex-1 border border-gray-300 rounded-l-lg p-1 focus:outline-none text-sm"
