...
function Viewall({realtimedealpipelinecompanyInfo,hidenavbar,filesadded,realtimeDealpipelinetabs,realtimetabchats,realtimedealpipelinecompany,filter, selectedTab,setActiveField }) {
