...
const Addusers = ({setActiveField,hidenavbar}) => {
    ...
    useEffect(()=>{
        const setUsers=async()=>{
            ...
            {
                const response=await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/fetchallusers',{
    ...
    const handleDelete=async(email)=>{
        let organization=localStorage.getItem('organization')
        const response=await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/deleteUser',{
    ...
    useEffect(()=>{
        const getUser=async()=>{
            let organization=localStorage.getItem('organization')
            const response=await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/fetchallusers',{organization:organization})
            setAllusers(response.data.data)
