...
function App() {
  ...
  const socket=io('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999')
  ...
  useEffect(()=>{
      const fun=async()=>{
        ...
        const response=await axios.post('http://ec2-13-232-103-3.ap-south-1.compute.amazonaws.com:8999/gettimeline',{organization:localStorage.getItem('organization')})
